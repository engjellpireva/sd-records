        ...
        <div class="col-md-12">
            <div class="card rounded-0">
                <div class="card-header rounded-0 bg-dark d-flex justify-content-between my-auto text-white">
                    ...
                    <div class="d-flex">
                        ...
                        <form method="POST" action="/warrants/arrest/details/approve/{{ $warrant->id }}">
                            @csrf
                ...
                <div class="card-body">
                    ...
                    <p class="my-auto">Type: <strong>{{ $warrant->type }}</strong></p>
                    @if($warrant->active === 1)
                    ...
                    @endif
                    <hr />
                    <p class="my-auto">Suspect Name: <strong>{{ $warrant->name }}</strong></p>
                    <p class="my-auto">Suspect Gender: <strong>{{ $warrant->gender }}</strong></p>
                    <p class="my-auto">Suspect Race: <strong>{{ $warrant->race }}</strong></p>
                    <p class="my-auto">Suspect Phone Number: <strong>{{ $warrant->number }}</strong></p>
                    <p class="my-auto">Suspect Description: <strong>{{ $warrant->description }}</strong></p>
                    <hr />
                    <p class="my-auto">Date and Time: <strong>{{ $warrant->date }}</strong></p>
                    <p class="my-auto">Narrative: <strong>{{ $warrant->narrative }}</strong></p>
                </div>
            </div>
            ...
            <div class="card rounded-0 mt-4">
                ...
                <div class="card-body">
                    ...
                    <hr />
                    <p>Add Comment</p>
                    <form method="POST" action="/warrants/arrest/comments/add/{{ $warrant->id }}">
                        @csrf
