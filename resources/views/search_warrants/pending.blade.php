    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card rounded-0">
                <div class="card-header rounded-0 bg-dark text-white">Pending Search Warrants</div>
                @if(count($warrants) === 0)
                    <p class="my-auto p-3">There are no pending warrants at the moment.</p>
                @else
                    ...
                    <table class="table table-borderless table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> <p class="my-auto text-black">{{ \Carbon\Carbon::parse($warrant->created_at)->diffForHumans() }}</p></td>
                                <td>
                                    @if($warrant->active === 1)
