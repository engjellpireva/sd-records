...
Route::middleware(['notifications'])->group(function() {
    ...
    Route::get('/individuals/create', [App\Http\Controllers\IndividualController::class, 'show'])->middleware('auth');
    Route::get('/individuals/view', [App\Http\Controllers\IndividualController::class, 'view'])->middleware('auth');
    Route::post('/individuals/create', [App\Http\Controllers\IndividualController::class, 'create'])->middleware('auth');
    Route::get('/individuals/view/{id}', [App\Http\Controllers\IndividualController::class, 'details'])->middleware('auth');
    Route::post('/individuals/view/{id}/add', [App\Http\Controllers\IndividualCommentController::class, 'add'])->middleware('auth');
    Route::get('/individuals/edit/{id}', [App\Http\Controllers\IndividualController::class, 'edit'])->middleware('auth');
    Route::post('/individuals/edit/{id}', [App\Http\Controllers\IndividualController::class, 'edit_insert'])->middleware('auth');
    ...
    Route::post('/warrants/arrest/details/close/{id}', [App\Http\Controllers\ArrestWarrantController::class, 'warrantClose'])->middleware(['auth', 'role:Administrator|Supervisor']);
    Route::post('/warrants/arrest/details/approve/{id}', [App\Http\Controllers\ArrestWarrantController::class, 'warrantApprove'])->middleware(['auth', 'role:Administrator|Supervisor']);
    ...
    Route::post('/warrants/search/details/close/{id}', [App\Http\Controllers\SearchWarrantController::class, 'warrantClose'])->middleware(['auth', 'role:Administrator|Supervisor']);
    Route::post('/warrants/search/details/approve/{id}', [App\Http\Controllers\SearchWarrantController::class, 'warrantApprove'])->middleware(['auth', 'role:Administrator|Supervisor']);
    ...
    Route::get('/admin/role/create', [App\Http\Controllers\AdminController::class, 'role_create'])->middleware(['auth', 'role:Administrator']);
    Route::post('/admin/role/create', [App\Http\Controllers\AdminController::class, 'role_create_insert'])->middleware(['auth', 'role:Administrator']);
